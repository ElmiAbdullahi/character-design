...
function displayStats() {
    ...
    reportEl.textContent = `You have changed the head ${headNumber} times, the body ${middleNumber} times, and the pants ${bottomNumber} times. And your character's catchphrase is:`;
}
